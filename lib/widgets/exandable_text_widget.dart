...
class _ExpandableTextWidgetState extends State<ExpandableTextWidget> {
  ...
  double textHeight = AppLayout.getScreenHeight() / 6.7;
  ...
  Widget build(BuildContext context) {
    return Container(
      child: secondHalf.isEmpty ? SmallText(color: AppColors.paraColor ,size: AppLayout.getHeight(16),text: firstHalf): Column(
        children: [
